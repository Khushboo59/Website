...
function gutener_business_default_styles(){

	// begin style block
	$css = '<style>';

	# Colors
	$site_primary_color = get_theme_mod( 'site_primary_color', '#f57251' );
	$blog_post_category_color = get_theme_mod( 'blog_post_category_color', '#f57251' );
	$notification_bar_button_background_color = get_theme_mod( 'notification_bar_button_background_color', '#f57251' );
	...
	if( get_theme_mod( 'disable_highlight_title_divider', true ) ){
		$css .= '
	...
	if( get_theme_mod( 'disable_footer_widget_title_border', true ) ){
		$css .= '
...
add_action( 'wp_head', 'gutener_business_default_styles', 99 );