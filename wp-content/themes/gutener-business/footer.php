...
?>
	...
	<?php
		...
		if( get_theme_mod( 'top_footer_widget_columns' , 'three_columns' ) == 'three_columns' ){
			$footer_widget_columns_class = 'col-lg-4';
		}elseif( get_theme_mod( 'top_footer_widget_columns' , 'three_columns' ) == 'two_columns' ){
			$footer_widget_columns_class = 'col-lg-6';
		}elseif( get_theme_mod( 'top_footer_widget_columns' , 'three_columns' ) == 'one_column' ){
	...
	<footer id="colophon" class="site-footer <?php echo esc_attr( $footer_layout . ' ' . $has_footer_bg ) ?>" style="background-image: url(<?php echo esc_url( $footer_image ) ?>">
		...
		<?php if( !get_theme_mod( 'disable_bottom_footer', false ) ) { ?>
			...
			if( get_theme_mod( 'footer_layout', 'footer_two' ) == '' || get_theme_mod( 'footer_layout', 'footer_two' ) == 'footer_one' ){ ?>
