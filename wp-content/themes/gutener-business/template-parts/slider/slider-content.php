	...
	<div class="banner-content <?php echo esc_attr( $alignmentClass ); ?>">
	    <div class="entry-content">
						...
						comments_popup_link(
							sprintf(
								wp_kses(
									...
									__( 'Comment<span class="screen-reader-text"> on %s</span>', 'gutener-business' ),
									array(
										'span' => array(
											'class' => array(),
										),
	        ...
	        <div class="entry-text">
				...
				if ( get_theme_mod( 'slider_button_type', 'button-primary' ) == 'button-primary' ){
					$button_type = 'button-primary';
				}elseif ( get_theme_mod( 'slider_button_type', 'button-primary' ) == 'button-text' ){
					$button_type = 'button-text';
				}

				if ( !get_theme_mod( 'hide_slider_button', false ) && get_theme_mod( 'slider_button_text', '' ) ){ ?>
