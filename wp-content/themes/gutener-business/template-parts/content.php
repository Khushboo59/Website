	    ...
	    <div class="entry-content">
	        ...
	        <div class="entry-text">
				<?php
					...
					if ( get_theme_mod( 'post_button_type', 'button-outline' ) == 'button-primary' ){
						$button_type = 'button-primary';
					}elseif ( get_theme_mod( 'post_button_type', 'button-outline' ) == 'button-outline' ){
						$button_type = 'button-outline';
					}
				?>
				<?php if ( !get_theme_mod( 'hide_post_button', false ) && get_theme_mod( 'post_button_text', '' ) ){ ?>
