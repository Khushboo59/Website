...
?>
	...
	$posts_per_page_count = get_theme_mod( 'highlight_posts_posts_number', 4 );
				...
				<?php
					if( !get_theme_mod( 'disable_pagination', false ) ):
						the_posts_pagination( array(
							'next_text' => '<span>'.esc_html__( 'Next', 'gutener-business' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Next page', 'gutener-business' ) . '</span>',
							'prev_text' => '<span>'.esc_html__( 'Prev', 'gutener-business' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Previous page', 'gutener-business' ) . '</span>',
							'before_page_number' => '<span class="meta-nav screen-reader-text">' . esc_html__( 'Page', 'gutener-business' ) . ' </span>',
						));
					endif;
				?>
			</div><!-- #primary -->
